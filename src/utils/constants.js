...
export const AppMessages = {
  ...
  NoBusinesses: "No business found...",
...
export const ValidationMessages = {
  ...
  MNameReq: "Middlename can not be empty.",
  ...
  MobileReq: "Primary phone can not be empty.",
  MobileInvalid: "Primary phone is not valid.",
  LandlineReq: "Secondary phone can not be empty.",
  LandlineInvalid: "Secondary phone is not valid.",
  ...
  AboutcompanyReq: "About company can not be empty.",
