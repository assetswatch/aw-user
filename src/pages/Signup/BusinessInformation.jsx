  ...
  const onContinue = (e) => {
    ...
    if (Object.keys(formErrors).length === 0) {
      ...
      setTimeout(() => {
        ...
        navigate(routeNames.supprofiletype.path);
      }, 500);
    } else {
      ...
      <div className="container-fluid login-wrapper row p-0 m-0">
        ...
        <div className="col-md-6 d-flex align-items-center justify-content-center bg-white box-shadow">
          <div className="form-section max-w-700px">
            <h6 className="mb-4 down-line pb-2">Tell us About Your Business</h6>
            <form noValidate onSubmit={onContinue}>
              <div className="row">
                <div className="col-12 mb-1">
                  <h6 className="mb-2 down-line pb-2">Company Information</h6>
                </div>
