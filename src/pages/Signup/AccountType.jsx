...
const AccountType = () => {
  ...
  const handleAccountTypeChange = (e) => {
    setFormData({
      ...formData,
      ["rblaccounttype"]: e?.currentTarget.getAttribute("value"),
    });
        ...
        <div className="col-md-6 d-flex align-items-center justify-content-center bg-white box-shadow">
          <div className="form-section max-w-700px">
            ...
            <div className="bg-white xs-p- 20 pb-20">
              <div className="row row-cols-lg-2 pt-20 row-cols-1 g-4 f lex-center">
                <div
                  className="col cur-pointer"
                  data-iscat={false}
                  value={config.userProfileAccountTypes.Personal}
                  onClick={(e) => {
                  ...
                  <div className="text-center px-4 py-20 bg-li-hover-color hoverbo1bg-primary rounded-2rem hover-shadow bo2-transparent transition2sl">
                    ...
                    <div className="mt-3">
                      ...
                      <p className="transation font-small font-500 lh-22">
                        {setUserAccountTypeDescText(
                          config.userProfileAccountTypes.Personal
                        )}
                      </p>
                    </div>
                  </div>
                ...
                <div
                  className="col cur-pointer"
                  data-iscat={true}
                  value={config.userProfileAccountTypes.Business}
                  onClick={(e) => {
                    handleAccountTypeChange(e);
                  }}
                >
                  <div className="text-center px-4 py-20 bg-li-hover-color hoverbo1bg-primary rounded-2rem hover-shadow bo2-transparent transition2sl">
                    <div>
                      <i className="fa fa-briefcase text-primary font-size-60" />
                    </div>
                    <div className="mt-3">
                      <span className="transation font-500 text-primary">
                      ...
                      <p className="transation font-small font-500 lh-22">
                        {setUserAccountTypeDescText(
                          config.userProfileAccountTypes.Business
                        )}
                      </p>
                    </div>
                  </div>
