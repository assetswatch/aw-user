        ...
        <div class="container">
          <div className="p-5">
            ...
            <p>
              <ul>
                <li>
                  Payment and transaction-based fraud prevention, which is to
                  help protect you, your tenants, owners, service professionals
                  you engage with and other{" "}
                  <strong className="text-primary">Assets Watch</strong> users.
                </li>
                <li>
                  Listing fraud prevention, which helps protect your listing
                  from others copying or stealing the listing in order to prey
            ...
            <p>
              <ul>
                ...
                <li>
                  ...
                  integrated partner services that help keep your account
                  running smoothly.
                </li>
              </ul>
            </p>
            ...
            <h6>Data Correction and Deletion</h6>
            <p>
