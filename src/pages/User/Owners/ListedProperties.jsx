...
const ListedProperties = () => {
      ...
      },
      {
        ...
        actions: [
          ...
          },
          {
            ...
            onclick: (e, row) => onAssignProperty(e, row),
          },
          {
            text: "Switch Zone",
  ...
  const onEdit = (e, row) => {
    ...
    if (
      ...
      navigate(routeNames.manageresidentialproperty.path);
    } else {
      navigate(routeNames.managecommercialproperty.path);
    }
  };
  ...
  const onAssignProperty = (e, row) => {
    e.preventDefault();
    addSessionStorageItem(SessionStorageKeys.EditAssetId, row.original.AssetId);
    navigate(routeNames.ownerassignproperty.path);
  };
  ...
  const navigateToPartnershipProperties = () => {
    navigate(routeNames.ownerpartnershipproperties.path);
  };
