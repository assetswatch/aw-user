  ...
  const onAddFolder = (e) => {
    ...
    if (Object.keys(formAddFolderErrors).length === 0) {
      ...
      let objBodyParams = {
        ...
        FolderId: 0,
        AccountId: foldersHierarchyData[0]?.AccountId,
        ProfileId: foldersHierarchyData[0]?.ProfileId,
  ...
  const onUploadFiles = async () => {
    ...
    if (Object.keys(formAddFileErrors).length === 0) {
      ...
      const uploadPromises = notstartedfiles.map((file, i) => {
        ...
        objBodyParams.append("ProfileId", foldersHierarchyData[0]?.ProfileId);
        objBodyParams.append("AccountId", foldersHierarchyData[0]?.AccountId);
