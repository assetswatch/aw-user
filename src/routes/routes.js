...
export const routeNames = {
  ...
  MyAgreement: { name: "MyAgreement", path: "/User/Agreements/MyAgreement" },
  Documents: { name: "Documents", path: "/User/Agreements/Documents" },
  AgreementTemplates: {
    name: "AgreementTemplates",
    path: "/User/Agreements/AgreementTemplates",
  },
  Reports: { name: "Reports", path: "/User/Reports/Reports" },
  Services: { name: "Services", path: "/User/Services/Services" },
  Agents: { name: "Agents", path: "/User/Agents/Agents" },
  Settings: { name: "Settings", path: "/User/Settings/Settings" },
...
const routes = [
  ...
  {
    path: routeNames.MyAgreement.path,
    name: routeNames.MyAgreement.name,
    element: lazy(() => import("../pages/User/Agreements/MyAgreement")),
    isexact: true,
    isprotected: true,
  },
  {
    path: routeNames.Documents.path,
    name: routeNames.Documents.name,
    element: lazy(() => import("../pages/User/Agreements/Documents")),
    isexact: true,
    isprotected: true,
  },
  {
  ...
  },
  {
    ...
    element: lazy(() => import("../pages/User/Reports/Reports")),
    isexact: true,
    isprotected: true,
  },
  {
  ...
  },
  {
    ...
    element: lazy(() => import("../pages/User/Agents/Agents")),
    isexact: true,
    isprotected: true,
  },
  {
