...
export const routeNames = {
  ...
  createnewrequest: { name: "CreateNewRequest", path: "/User/Services/CreateNewRequest" },
...
const routes = [
  ...
  {
    path: routeNames.createnewrequest.path,
    name: routeNames.createnewrequest.name,
    element: lazy(() => import("../pages/User/Services/CreateNewRequest")),
    isexact: true,
    isprotected: true,
  },
  {
