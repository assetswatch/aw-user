...
export const routeNames = {
  ...
  addownerprofile: { name: "AddOwnerProfile", path: "/User/Add-Owner-Profile" },
  addagentprofile: { name: "AddAgentProfile", path: "/User/Add-Agent-Profile" },
  addtenantprofile: {
    name: "AddTenantProfile",
    path: "/User/Add-Tenant-Profile",
  },
...
const routes = [
  ...
  {
    path: routeNames.addownerprofile.path,
    name: routeNames.addownerprofile.name,
    element: lazy(() => import("../pages/User/AddProfile/AddOwnerProfile")),
    isexact: true,
    isprotected: true,
  },
  {
    path: routeNames.addagentprofile.path,
    name: routeNames.addagentprofile.name,
    element: lazy(() => import("../pages/User/AddProfile/AddAgentProfile")),
    isexact: true,
    isprotected: true,
  },
  {
    path: routeNames.addtenantprofile.path,
    name: routeNames.addtenantprofile.name,
    element: lazy(() => import("../pages/User/AddProfile/AddTenantProfile")),
    isexact: true,
    isprotected: true,
  },
  {
