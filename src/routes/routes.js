...
export const routeNames = {
  ...
  signin: { name: "Login", path: "/Signin/:id?" },
  signup: { name: "Register", path: "/Signup/:id?" },
  supaccountinfo: { name: "SupAccountInfo", path: "/Signup/AccountInfo" },
  supaccounttype: { name: "SupAccountType", path: "/Signup/AccountType" },
  supbusinessinfo: { name: "SupBusinessInfo", path: "/Signup/BusinessInfo" },
  supprofiletype: { name: "SupProfileType", path: "/Signup/ProfileType" },
  supservices: { name: "SupServices", path: "/Signup/Services" },
  oauthcallback: { name: "OAuth", path: "/oauth/callback" },
  ...
  profilesettings: { name: "ProfileSettings", path: "/User/ProfileSettings" },
  profileinfo: {
    name: "ProfileInfo",
  ...
  businesses: { name: "Businesses", path: "/User/Business" },
  addbusiness: { name: "AddBusiness", path: "/User/AddBusiness" },
  businessmembers: { name: "BusinessMembers", path: "/User/Business/Members" },
  businessaddmember: {
    name: "BusinessAddMember",
    path: "/User/Business/AddMember",
  },
...
const routes = [
  ...
  {
    path: routeNames.supaccountinfo.path,
    name: routeNames.supaccountinfo.name,
    element: lazy(() => import("../pages/Signup/AccountInformation")),
    isexact: true,
  },
  {
    path: routeNames.supaccounttype.path,
    name: routeNames.supaccounttype.name,
    element: lazy(() => import("../pages/Signup/AccountType")),
    isexact: true,
  },
  {
    path: routeNames.supbusinessinfo.path,
    name: routeNames.supbusinessinfo.name,
    element: lazy(() => import("../pages/Signup/BusinessInformation")),
    isexact: true,
  },
  {
    path: routeNames.supprofiletype.path,
    name: routeNames.supprofiletype.name,
    element: lazy(() => import("../pages/Signup/ProfileType")),
    isexact: true,
  },
  {
    path: routeNames.supservices.path,
    name: routeNames.supservices.name,
    element: lazy(() => import("../pages/Signup/Services")),
    isexact: true,
  },
  {
    path: routeNames.oauthcallback.path,
    name: routeNames.oauthcallback.name,
    element: lazy(() => import("../oauth/OAuthCallBack")),
    isexact: true,
  },
  {
  ...
  {
    path: routeNames.profilesettings.path,
    name: routeNames.profilesettings.name,
    element: lazy(() => import("../pages/User/Settings/ProfileSettings")),
    isexact: true,
    isprotected: true,
  },
  {
    path: routeNames.profileinfo.path,
    name: routeNames.profileinfo.name,
    element: lazy(() => import("../pages/User/Settings/Profile")),
    isexact: true,
    isprotected: true,
  },
  {
    ...
    element: lazy(() => import("../pages/User/Settings/ChangePassword")),
    isexact: true,
    isprotected: true,
  },
  {
    path: routeNames.notificationsettings.path,
    name: routeNames.notificationsettings.name,
    element: lazy(() => import("../pages/User/Settings/Notifications")),
    isexact: true,
    isprotected: true,
  },
  {
  ...
  {
    path: routeNames.businesses.path,
    name: routeNames.businesses.name,
    element: lazy(() => import("../pages/User/Business/Businesses")),
    isexact: true,
    isprotected: true,
  },
  {
    path: routeNames.addbusiness.path,
    name: routeNames.addbusiness.name,
    element: lazy(() => import("../pages/User/Business/AddBusiness")),
    isexact: true,
    isprotected: true,
  },
  {
    path: routeNames.businessmembers.path,
    name: routeNames.businessmembers.name,
    element: lazy(() => import("../pages/User/Business/Members")),
    isexact: true,
    isprotected: true,
  },
  {
    path: routeNames.businessaddmember.path,
    name: routeNames.businessaddmember.name,
    element: lazy(() => import("../pages/User/Business/AddMember")),
    isexact: true,
    isprotected: true,
  },
  {
