...
export const routeNames = {
  ...
  ownersettings: { name: "OwnerSettings", path: "/User/Owner-Settings" },
  ...
  tenantsettings: { name: "TenantSettings", path: "/User/Tenant-Settings" },
  ...
  agentsettings: { name: "AgentSettings", path: "/User/Agent-Settings" },
...
const routes = [
  ...
  {
    path: routeNames.ownersettings.path,
    name: routeNames.ownersettings.name,
    element: lazy(() => import("../pages/User/Owners/Settings")),
    isexact: true,
    isprotected: true,
  },
  {
  ...
  {
    path: routeNames.tenantsettings.path,
    name: routeNames.tenantsettings.name,
    element: lazy(() => import("../pages/User/Tenants/Settings")),
    isexact: true,
    isprotected: true,
  },
  {
  ...
  {
    path: routeNames.agentsettings.path,
    name: routeNames.agentsettings.name,
    element: lazy(() => import("../pages/User/Agents/Settings")),
    isexact: true,
    isprotected: true,
  },
  {
