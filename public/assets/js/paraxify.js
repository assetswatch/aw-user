...
(function (document, window, index) {
  ...
  paraxify = function (el, options) {
    ...
    Paraxify.prototype = {
          ...
          if (main.bgSize === "" || main.bgSize === "auto") {
            if (this.height < main.offsetHeight) {
              ...
              if (this.height < screenY) {
                actualHeight =
                  actualHeight + (screenY - main.offsetHeight) * opt.speed;
              }
            }
      ...
      _visible: function (i) {
        if (
          posY + screenY > pho[i].offsetTop &&
          posY < pho[i].offsetTop + pho[i].offsetHeight
        ) {
          return true;
        }
        return false;
      ...
      _animate: function () {
        ...
        while (i < pho.length) {
          ...
          if (
            pho[i].ok &&
            window.getComputedStyle(pho[i], false).backgroundAttachment ===
              "fixed" &&
            this._visible(i)
          ) {
            per =
              (posY - pho[i].offsetTop + screenY) /
